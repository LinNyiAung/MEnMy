        ...
        actions: [
          ...
          Consumer<AccountProvider>(
            builder: (context, accountProvider, child) {
              return TextButton(
                onPressed: accountProvider.isLoading ? null : _updateAccount,
                child: Text(
                  'Save',
                  style: TextStyle(
                    color: accountProvider.isLoading ? Colors.white54 : Colors.white,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Changes will be saved automatically when you tap Update Account.',
                        style: TextStyle(
